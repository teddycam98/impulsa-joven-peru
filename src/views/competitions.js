  ...
  return `
    <div id="competitionsView" class="container" style="margin-bottom: 2rem; padding-top: 260px;">
      <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 40px;">
        ...
        <h1 style="color: white; font-size: 3rem; font-weight: 900; margin-bottom: 10px;">Concursos</h1>
        <p class="muted" style="font-size: 1.1rem; max-width: 600px;">Concursos, hackathons, premios, convocatorias e innovación juvenil para demostrar tu talento.</p>
      </div>
      ...
      <div style="background: rgba(255,255,255,0.04); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; padding: 16px 20px; margin-bottom: 30px; display: flex; flex-wrap: wrap; gap: 16px; align-items: center; justify-content: space-between;">
        <div style="flex: 1; min-width: 250px; position: relative;">
          ...
          <input type="text" id="searchInput" placeholder="Buscar concurso por título o institución..." aria-label="Buscar concursos" style="width: 100%; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: white; border-radius: 10px; padding: 12px 15px 12px 40px; font-family: 'Outfit', sans-serif; font-size: 0.95rem; transition: all 0.3s ease;">
        </div>
