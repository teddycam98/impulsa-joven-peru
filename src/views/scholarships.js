  ...
  return `
    <div id="scholarshipsView" class="container" style="margin-bottom: 2rem; padding-top: 260px;">
      <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 40px;">
        ...
        <h1 style="color: white; font-size: 3rem; font-weight: 900; margin-bottom: 10px;">Becas Disponibles</h1>
        <p class="muted" style="font-size: 1.1rem; max-width: 600px;">Accede a becas nacionales e internacionales para estudiar en las mejores universidades del mundo.</p>
      </div>
