  ...
  return `
    <div id="jobsView" class="container" style="margin-bottom: 2rem; padding-top: 260px;">
      <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 40px;">
        ...
        <h1 style="color: white; font-size: 3rem; font-weight: 900; margin-bottom: 10px;">Primer Empleo y Prácticas</h1>
        <p class="muted" style="font-size: 1.1rem; max-width: 600px;">Encuentra oportunidades laborales diseñadas para jóvenes sin experiencia o estudiantes de últimos ciclos.</p>
      </div>
