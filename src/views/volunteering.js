...
export function renderVolunteering() {
  ...
  return `
    <div id="volunteeringView" class="container mb-2 animate-on-scroll">
      <div class="flex-center" style="flex-direction: column; text-align: center; margin-bottom: 30px;">
        <h1 class="text-dark" style="font-size: 3.5rem; font-weight: 900; margin-bottom: 10px;">Voluntariados</h1>
        <p class="muted" style="font-size: 1.1rem; max-width: 600px;">Únete a iniciativas sociales, ambientales y comunitarias para hacer la diferencia mientras aprendes.</p>
      </div>
      ...
      <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 20px; margin-bottom: 30px; display: flex; flex-wrap: wrap; gap: 20px; align-items: center; justify-content: space-between;">
        <div style="flex: 1; min-width: 250px;">
          <input type="text" id="searchInput" placeholder="Buscar por ONG o actividad..." style="width: 100%; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: white; border-radius: 10px; padding: 12px 15px;">
        </div>
