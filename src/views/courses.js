...
export function renderCourses() {
  ...
  return `
    <div id="coursesView" class="container inner-page" style="margin-bottom: 2rem;">
      <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 40px;">
        ...
        <h1 style="color: white; font-size: 3rem; font-weight: 900; margin-bottom: 10px;" data-i18n="cat.courses.title">Cursos Gratuitos</h1>
        <p class="muted" style="font-size: 1.1rem; max-width: 600px;" data-i18n="cat.courses.desc">Mejora tus habilidades con cursos en línea de las mejores plataformas tecnológicas y educativas del mundo.</p>
      </div>
      ...
      <div style="background: rgba(255,255,255,0.04); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; padding: 16px 20px; margin-bottom: 30px; display: flex; flex-wrap: wrap; gap: 16px; align-items: center; justify-content: space-between;">
        <div style="flex: 1; min-width: 250px; position: relative;">
          ...
          <input type="text" id="searchInput" data-i18n="cat.courses.search" placeholder="Buscar curso por título o plataforma..." aria-label="Buscar cursos" style="width: 100%; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: white; border-radius: 10px; padding: 12px 15px 12px 40px; font-family: 'Outfit', sans-serif; font-size: 0.95rem; transition: all 0.3s ease;">
        </div>
